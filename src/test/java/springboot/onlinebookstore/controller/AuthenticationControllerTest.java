...
class AuthenticationControllerTest {
    ...
    void register_ValidRequest_ReturnsValidResponse() throws Exception {
        ...
        MockMvcResultMatchers.jsonPath(str, expected);
        assertThat(str, containsString(expected.email()));
        String json = JsonPath.parse(result.getResponse().getContentAsByteArray()).jsonString();
